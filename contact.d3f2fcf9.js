...
function makeRequest(data) {
  ...
  httpRequest.open('GET', "https://script.google.com/macros/s/AKfycbzRS0rz8tThx1RVTffcaGv8i3mz0d1r4HB2z2IWYh7BuE45P7s4/exec?".concat(toQueryString(data)));
  httpRequest.send();
}
function toQueryString(data) {
  let params = [];
  for (let _ref of Object.entries(data)) {
