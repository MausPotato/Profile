...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/handmadeAdGallery.js":[function(require,module,exports) {
...
adButtons.forEach(button => {
  button.addEventListener('click', () => {
    const _button$dataset = button.dataset,
      title = _button$dataset.title,
      category = _button$dataset.category,
    ...
    adLink.href = url;
    adFrame.title = "".concat(title, " mobile preview");
    adFrame.src = url;
  });
});
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/handmadeAdGallery.js"], null)
//# sourceMappingURL=/handmadeAdGallery.0909cb20.js.map